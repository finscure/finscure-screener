...
export default function TopNav({ activePage, onNavigate, onToggleTheme, theme }) {
    ...
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{
          ...
          <span>🔍</span> Search...
          <kbd style={{
            background: "var(--kbd-bg)", padding: "1px 6px", borderRadius: 4,
        ...
        <div onClick={onToggleTheme} title="Toggle theme" style={{
          ...
          transition: "all 0.3s", display: "flex", alignItems: "center", padding: "0 5px",
          flexShrink: 0,
        }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            {showUserMenu && (
              <div style={{
                ...
                <div style={{ padding: "8px 10px", fontSize: 11, color: "var(--text-muted)", borderBottom: "1px solid var(--border)", marginBottom: 4 }}>
                  {user.email}
                </div>
